...
echo "<tr><th> NO </th><th> KODE MK </th><th> NAMA MK </th><th width='50'> SKS </th><th width='100'> SEMESTER </th><th width='100'> ID DOSEN </th><th colspan=2>AKSI</th></tr>";
echo "</form>";
while ($b = mysqli_fetch_array($a)) {
    $no = $no + 1;
    echo "<tr><td> $no </td> <td> $b[kode_mk] </td> <td> $b[nama_mk] </td> <td>$b[sks]</td><td>$b[smt]</td><td>$b[id_dosen]</td>";
